...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <form action="{{ route('meeting-rooms.update', $agenda->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <button type="submit" class="btn-submit mt-6 bg-blue-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-blue-600 transition duration-200">Update Agenda</button>
        </form>
    </div>
